...
@echo mt-engine
call scp mt-engine\target\mt-engine-0.0.1-SNAPSHOT.jar root@47.108.131.61:~/
@echo mt-gateway
call scp mt-gateway\target\mt-gateway-0.0.1-SNAPSHOT.jar root@47.108.131.61:~/
@echo mt-socket
call scp mt-socket\target\mt-socket-0.0.1-SNAPSHOT.jar root@47.108.131.61:~/
@echo mt-user
call scp mt-user\target\mt-user-0.0.1-SNAPSHOT.jar root@47.108.131.61:~/
