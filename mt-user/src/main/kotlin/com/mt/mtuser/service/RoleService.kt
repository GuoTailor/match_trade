...
class RoleService {
    ...
    suspend fun update(sh: Stockholder) = stockholderDao.update(
        sh.id!!, sh.userId, sh.roleId, sh.companyId, sh.realName,
    ...
    suspend fun countByCompanyIdAndRoleId(companyId: Int, roleId: Int) =
        stockholderDao.countByCompanyIdAndRoleId(companyId, roleId)

    fun findByCompanyId(companyId: Int) = stockholderDao.findByCompanyId(companyId)

    suspend fun findByUserIdAndCompanyId(userId: Int, companyId: Int) =
        stockholderDao.findByUserIdAndCompanyId(userId, companyId)

    suspend fun findByUserIdAndRoleId(userId: Int, roleId: Int) = stockholderDao.findByUserIdAndRoleId(userId, roleId)

    suspend fun findByRoleIdAndCompanyId(roleId: Int, companyId: Int) =
        stockholderDao.findByRoleIdAndCompanyId(roleId, companyId)
    ...
    suspend fun deleteByRoleIdAndCompanyId(roleId: Int, companyId: Int): Int =
        stockholderDao.deleteByRoleIdAndCompanyId(roleId, companyId)
