...
class SessionHandler {
    ...
    private val source: Sinks.Many<String> = Sinks.many().multicast().onBackpressureBuffer()
    ...
    fun tryEmitComplete(): Sinks.EmitResult = source.tryEmitComplete()
    fun asFlux(): Flux<String> = source.asFlux()
